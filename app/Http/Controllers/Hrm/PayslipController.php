...
class PayslipController extends Controller
{
    ...
    public function payslip($id)
    {
        $payslips = DB::table('hrm_salary_payment')
            ...
            ->select(
                'hrm_employee.*',
                'hrm_salary_payment.*',
                'hrm_fonctions.title as fonction',
                'hrm_department.title as department',
                'hrm_employee_payroll.transport_allowance'
            )
    ...
    public function generate_payslip($month, $employees)
    {
        ...
        foreach ($employees as $key => $employee) {
            ...
            $pension_complementaire = $employee->salary->pension_complementaire ?? 0;
            ...
            $tax_base = $gross_salary - $pension_salariale - $totalAllowances;
            ...
            $net_salary = $gross_salary - $pension_salariale - $IPR - $pension_complementaire - $caisse_sociale - $totalRetenues;
