...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/chamber.css') }}">
        ...
        <nav id="sidebar" class="active noprint">
            ...
            <ul class="list-unstyled components mb-5">
                @can('is-vente')
                    ...
                    <li>
                        <a href="{{ route('clients.index') }}" class="{{ setActiveRoute('clients.*') }}"><span
                                class="fa fa-users"></span> Client</a>
                    </li>
                    {{-- <li>
                ...
                @can('is-admin')
                    <li>
                        <a href="{{ route('products.index') }}" class="{{ setActiveRoute('products.*') }}"><span
                                class="fa fa-sticky-note"></span> Stock</a>
                    </li>

                    <li>
                        <a href="{{ route('rapport') }}" class="{{ setActiveRoute('rapport') }}"><span
                                class="fa fa-chart-bar"></span> Rapport</a>
                    </li>
                    <li>
                        <a href="{{ route('stockes.journal') }}" class="{{ setActiveRoute('stockes.*') }}"><span
                                class="fa fa-calendar"></span> Journal</a>
                    </li>

                    @if (USE_ABONEMENT)
                        <li>
                            <a href="{{ route('comptes.index') }}" class="{{ setActiveRoute('comptes.*') }}"><span
                                    class="fa fa-hand-holding-usd" aria-hidden="true"></span> Abonement</a>
                        </li>
                    @endif

                    <li>
                        <a href="{{ route('employee.index') }}" class="{{ setActiveRoute('employee.*') }}" ><span class="fa fa-list"></span> HR</a>
                    </li>
                    <li>
                        <a href="{{ route('depenses.index') }}" class="{{ setActiveRoute('depenses.*') }}"><span
                    ...
                    <li>
                        <a href="{{ route('users.index') }}" class="{{ setActiveRoute('users.*') }}"><span
                                class="fas fa-cogs"></span> Système</a>
                    </li>
                    <li></li>
                    {{--  <li>
                        ...
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('panier.index') }}" class="btn btn-primary">
                                    <i class="fa fa-shopping-cart text-lg-center"></i> <span
