<div>
    ...
    <div class="p-3 border-bottom">
        <input type="text" placeholder="Rechercher par nom ou description" wire:model.debounce.300ms="houseNumber" class="form-control form-control-sm">
    </div>
    ...
    @else
    <p class="p-3 text-muted mb-0">Aucune maison avec locataire trouvée.</p>
    @endif
</div>
