...
<form action="{{ route('employee.update', ['employee' => $employee]) }}" method="post">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3>Modification d'un employée</h3>
        </div>
        ...
        <div class="col-lg-6 col-md-6">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 @error('fonction_id') is-invalid @enderror" name="fonction_id" id="fonction_id" data-toggle="select2">
                    ...
                    <option {{ $employee->fonction_id == $val->fonction_id ? 'selected' : '' }}
                    value="{{ $val->fonction_id }}">{{ $val->title }}</option>
                    @endforeach
                </select>
                @error('fonction_id')
                    <div class="alert alert-danger">
            ...
            <div class="form-group" id="leaving_date_picker">
                ...
                <input type="date" class="form-control dateTimePickers" id="leaving_date"
                    name="leaving_date"  value="{{ old('leaving_date', $employee->leaving_date) }}">
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 @error('gender') is-invalid @enderror" name="gender" id="gender" data-toggle="select2">
                    ...
                    <option value="homme" {{ $employee->gender == 'homme' ? 'selected' : '' }}>Homme
                    </option>
                    <option value="Femme" {{ $employee->gender == 'Femme' ? 'selected' : '' }}>Femme
                    </option>
                </select>
                @error('gender')
                    <div class="alert alert-danger">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('cni_number') is-invalid @enderror" id="cni_number"
                    name="cni_number" value="{{ old('cni_number', $employee->cni_number) }}">
                @error('cni_number')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="code_inss"
                    name="code_inss" value="{{ old('code_inss', $employee->code_inss) }}">
            </div>

            <div class="form-group">
                <label class="form-label" for="full_address">Addresse</label>
                <input type="text" class="form-control" id="full_address"
                    name="full_address" value="{{ old('full_address', $employee->full_address) }}">
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
                ...
                <select class="form-control select2" name="bank_id" id="bank_id" data-toggle="select2">
                    ...
                    <option value="{{ $val->bank_id }}"
                        {{ $val->bank_id == $bank_emp->bank_id ? 'selected' : '' }}>
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="account_number"
                    name="account_number" value="{{ old('account_number', $bank_emp->account_number) }}">
            </div> <!-- end col -->
        </div>
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group mb-4">
                ...
                <input type="number" class="form-control @error('basic_salary') is-invalid @enderror" id="basic_salary"
                    name="basic_salary" value="{{ old('basic_salary', $salary->basic_salary) }}" onchange="calcNetSalary()" oninput="calcNetSalary()" >
                @error('basic_salary')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group mb-3">
                ...
                <select class="select2 form-control select2-multiple" data-toggle="select2"
                    ...
                    @foreach($indeminities as $value)
                        <option value="{{ $value->type_indeminite_id }}" 
                        {{ in_array($value->type_indeminite_id,explode(',',$salary->transport_allowance)) ? 'selected' : '' }}>

                                {{ $value->title . '' . $value->percentage . '%' }}</option>
                    @endforeach
                </select>
            </div>
        </div> <!-- end col -->
        ...
        <div class="col-lg-6 col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="net_salary"
                    name="net_salary" readonly value="{{ old('net_salary', $salary->net_salary) }}">
