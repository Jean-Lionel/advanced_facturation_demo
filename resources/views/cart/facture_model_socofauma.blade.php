    ...
    <div class="container_body">
        ...
        <div class="main-content" id="printJS-form" >
            ...
            <div id="facture_principal">
                <div class="header">
                    <div class="logo-container">
                        <img src="{{ asset('img/logosocofouma.jpg')}}" alt="" style="width: 100%;" height="70%">
                    </div>
                </div>
            {{-- Fin --}}
            ...
            <article>
                ...
                <div class="footer">
                    TEL: +226 68 511 768 - 70 437 843 - 79 359 237 - FAX: +226 - NIF: 00055634X - E-mail: socofouma@gmail.com<br>
                    Adresse: Oubithenga 2, Avenue du palmier N°58, Ouagadougou - Burkina
                </div>
            </div>
