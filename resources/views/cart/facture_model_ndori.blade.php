        ...
        <div class="main-content" id="printJS-form">
            ...
            <div id="facture_principal">
                ...
                <h3 class="text-center">
                    ...
                    @endif
                    N° {{ $order->id }} du {{ $order->created_at->format('d-m-Y à H:i:s') }}
                </h3>
                ...
                <article>
                    ...
                    <div>
                        Nous disons <b>{{ getNumberToWord($order->amount) }} {{ $order->invoice_currency ?? 'FBU' }} .</b>
                    </div>
            ...
            <div class="container">
                ...
                <h3 class="center">
                    ...
                    @if ($order->type_paiement == 3)
                        {{TYPE_PAYMENT[$order->type_paiement]}}
                    @endif
                    N° {{ $order->id }} du {{ $order->created_at->format('d-m-Y H:i:s') }}
                </h3>
                                ...
                                <tr>
                                    <td>
                                        @if (isset(explode("||", $product['name'])[1]))
                                            <b>{{ explode("||", $product['name'])[1] }}</b> <br>
                                        @endif
                                        {{ $product['quantite'] }} X {{ $product['name'] }}
                                    </td>
