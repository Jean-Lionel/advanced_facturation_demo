    ...
    <div class="container py-4">
        ...
        <div class="card shadow-sm mb-4 border-primary">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <span><i class="fa fa-database"></i> Migrations de la base de données</span>
                <span class="badge badge-light text-dark">
                    {{ $ranMigrationsCount }} / {{ $totalMigrationsCount }} exécutées
                </span>
            </div>
            <div class="card-body">
                ...
                @else
                    ...
                    <form action="{{ route('env_settings.run_migrations') }}" method="POST"
                        ...
                        <button type="submit" class="btn btn-warning">
                            <i class="fa fa-play"></i> Synchroniser la base (tables/colonnes manquantes)
                        </button>
